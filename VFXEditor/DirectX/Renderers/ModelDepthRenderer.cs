...
namespace VfxEditor.DirectX.Renderers {
    public abstract class ModelDepthRenderer : ModelRenderer {
        ...
        protected ModelDepthRenderer( Device device, DeviceContext ctx, string shaderPath ) : base( device, ctx, shaderPath ) { }
