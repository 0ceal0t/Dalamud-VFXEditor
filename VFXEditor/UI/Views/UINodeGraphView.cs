...
namespace VFXEditor.UI.VFX {
    public class UINodeGraphView : UIBase {
        ...
        static readonly uint BGColor = ImGui.GetColorU32( new Vector4( 0.13f, 0.13f, 0.13f, 1 ) );
        static readonly uint BGColor2 = ImGui.GetColorU32( new Vector4( 0.3f, 0.3f, 0.3f, 1 ) );
        static readonly uint BorderColor = ImGui.GetColorU32( new Vector4( 0.1f, 0.1f, 0.1f, 1 ) );
        static readonly uint TextColor = ImGui.GetColorU32( new Vector4( 0.9f, 0.9f, 0.9f, 1 ) );
        static readonly uint NodeColor = ImGui.GetColorU32( new Vector4( 0.25f, 0.25f, 0.25f, 1 ) );
        static readonly uint LineColor = ImGui.GetColorU32( new Vector4( 0.7f, 0.7f, 0.7f, 1 ) );
        static Vector2 HeaderSize = new( 160, 20 );
        static Vector2 BoxSize = new( 160, 40 );
        static Vector2 Spacing = new( 200, 100);
        static Vector2 TextOffset = new( 5, 2 );
        static Vector2 LineOffset = new( 0, 25 );

        static readonly uint GridColor = ImGui.GetColorU32( new Vector4( 0.1f, 0.1f, 0.1f, 1 ) );
        static readonly int GridSmall = 10;
        static readonly int GridLarge = 50;

        bool ViewDrag = false;
        Vector2 LastDragPos;
        Vector2 OFFSET = new( -30, -50 );
