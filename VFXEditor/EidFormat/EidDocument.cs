...
namespace VfxEditor.EidFormat {
    public class EidDocument : FileManagerDocument<EidFile, WorkspaceMetaBasic> {
        ...
        public EidDocument( EidManager manager, string writeLocation, string localPath, SelectResult source, SelectResult replace ) : base( manager, writeLocation, localPath, source, replace, "Eid", "eid" ) { }
