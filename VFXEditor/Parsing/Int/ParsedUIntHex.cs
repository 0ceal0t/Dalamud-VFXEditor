...
namespace VfxEditor.Parsing.Int {
    public class ParsedUIntHex : ParsedUInt {
        ...
        public override void Draw( CommandManager manager ) {
            ...
            using( var color1 = ImRaii.PushColor( ImGuiCol.ButtonHovered, ImGui.GetColorU32( ImGuiCol.Button ) ) )
            using( var color2 = ImRaii.PushColor( ImGuiCol.ButtonActive, ImGui.GetColorU32( ImGuiCol.Button ) ) )
